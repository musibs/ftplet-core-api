...
/**
 * Interface to reply for a FTP request. 
 * 
 * List of FTP replies can be found at {@link https://www.freesoft.org/CIE/RFC/959/24.htm}
 * 
 * @author musib
 *
 */
public interface FtpReply {
	...
	/*
	 * 100 series reply codes - The requested action is being initiated,
	 * except another reply before proceeding with a new command.
	 */
	 ...
	 */
	public static final int REPLY_150_FILE_STATUS_OK = 150;
	
	
	/*
	 * 200 series reply codes - The requested action has been successfully completed
	 */
	
	/**
	 *  200 Command Okay
	 */
	public static final int REPLY_200_COMMAND_OK = 200;
	...
	/**
	 * 214	Help message. Explains how to use the server or the meaning of a particular 
	 * non-standard command. This reply is useful only to the human user.
	 */
	public static final int REPLY_214_HELP_MESSAGE = 214;
	
	/**
	 * 215	NAME system type. Where NAME is an official system name from the registry 
	 * kept by IANA.
	 */
	 ...
	 */
	public static final int REPLY_220_SERVICE_REAY_FOR_NEW_USER = 220;
	
	/**
	 * 221	Service closing control connection.
	 */
	public static final int REPLY_221_SERVICE_CLOSING_CONTROL_CONNECTION = 221;
	 ...
	 */
	public static final int REPLY_228_ENTERING_LONG_PASSIVE_MODE = 228;
	
	/**
	 * 229	Entering Extended Passive Mode.
	 */
	public static final int REPLY_229_ENTERING_EXTENDED_PASSIVE_MODE = 229;
	 ...
	 */
	public static final int REPLY_250_REQUESTED_FILE_ACTION_OK = 250;
	...
	/*
	 * 300 series reply codes - The command has been accepted, but the requested action 
	 ...
	 */
	public static final int REPLY_350_REQUEST_FILE_ACTION_PENDING_FURTHER_INFORMATION = 350;
	
	/*
	 * 400 series reply codes - The command was not accepted and the requested action did 
	 * not take place, but the error condition is temporary and the action may be requested again.
	 */
	 ...
	 */
	public static final int REPLY_425_CANNOT_OPEN_DATA_CONNECTION = 425;
	 ...
	 */
	public static final int REPLY_430_INVALID_USERNAME_OR_PASSWORD = 430;
	
	/**
	 * 434	Requested host unavailable.
	 */
	public static final int REPLY_434_REQUESTED_HOST_UNAVAILABLE = 434;
	...
	/*
	 * 500 series reply codes - Syntax error, command unrecognized and the requested action 
	 * did not take place. This may include errors such as command line too long.
	 */
	 ...
	 */
	public static final int REPLY_552_REQUESTED_FILE_ACTION_ABORTED_EXCEED_STORE_ALLOCATION = 552;
	...
	/**
	 * The reply message. Reply message can be multiple lines
	 * @return The reply message. Reply message can be multiple lines
	 */
	public String getMessage();
	
	/**
	 * Returns the sent time (milliseconds since the epoch time) when this
	 * reply was sent out
	 * @return Returns the sent time (milliseconds since the epoch time) when this
	 * reply was sent out
	 */
	public long getSentTime();
	
	/**
	 * Must implement toString to format the reply as descried in RFC. Important
	 * consideration is to handle multiple lines.
	 * 
	...
	/**
	 * Tells whether this reply indicates a positive completion.
	 * @return <code>true</code> if this reply is a positive completion or a positive
	 * intermediate completion. <code>false</code> otherwise. 
	 */
	boolean isPostive();
}
